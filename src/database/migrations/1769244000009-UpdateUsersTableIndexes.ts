...
export class UpdateUsersTableIndexes1769244000009
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('admin', 'mentor', 'volunteer', 'project_owner')`);
    await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "role" DROP DEFAULT`);
    await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "role" TYPE "public"."users_role_enum" USING "role"::"text"::"public"."users_role_enum"`);
    await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "role" SET DEFAULT 'volunteer'`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    // Revert enum rename
    await queryRunner.query(`CREATE TYPE "public"."user_role_enum_old" AS ENUM('admin', 'mentor', 'volunteer', 'project_owner')`);
    await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "role" DROP DEFAULT`);
    ...
    await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "username" SET DEFAULT ''`);
